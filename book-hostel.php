...
$outsidedelhi=$_POST['outsidedelhi'];
$backlog=$_POST['backlog'];
$category=$_POST['category'];
$query="insert into  registration(roomno,seater,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresState,corresPincode,pmntAddress,pmntCity,pmnatetState,pmntPincode,outsideDelhi,backlog,category) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('iiiisisissssisississsisssisss',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode,$outsidedelhi,$backlog,$category);
$stmt->execute();
...
<div class="form-group">
<label class="col-sm-2 control-label">12th Percentage: </label>
<div class="col-sm-8">
<input type="text" name="12thper" id="12thper"  class="form-control" required="required">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Outside Delhi: </label>
<div class="col-sm-8">
<select name="outsidedelhi" id="outsidedelhi"  class="form-control">
...
<div class="form-group">
<label class="col-sm-2 control-label">Backlog: </label>
<div class="col-sm-8">
<select name="backlog" id="backlog" class="form-control">
<option value="">Select</option>
<option value="Yes">Yes</option>
<option value="No">No</option>
...
<div class="col-sm-6 col-sm-offset-4" id="buttons">
<button class="btn btn-default" type="submit">Cancel</button>
<input type="submit" name="submit" Value="Register" class="btn btn-primary" onClick="enabled">
</div>
</form>
<?php } ?>
