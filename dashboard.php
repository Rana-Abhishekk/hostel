						...
						<div class="row">
							<div class="col-md-12">
								<div class="row">
									...
									<!-- This is Hostel leaving undertaking  -->
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">

												<div class="stat-panel-number h1 "> Leave Hostel</div>
													
												</div>
											</div>
											<a href="undertaking.php" class="block-anchor panel-footer text-center">Undertaking to leave hostel &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
