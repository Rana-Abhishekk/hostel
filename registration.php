...
$query="insert into  userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,password,rank) values(?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssisss',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$password,$rank);
$stmt->execute();
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Student Registration - GTBIT hostel department </h2>
...
<div class="col-sm-8">
<input type="text" name="rank" id="rank"  class="form-control" required="required">
<span id="user-reg-availability" style="font-size:12px;"></span>
</div>
</div>
